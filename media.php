    ...
    <div class="wrapper" id="wrapper">
        ...
        <div class="navbar" id="navbar">
            <nav>
                ...
                <a class="a-nav" href="?page=kontak-kami"><i class="fa-solid fa-envelope"></i> Kontak Kami</a>
            </nav>
        </div>
        <!-- ./navbar -->
        ...
        <div class="footer">
            <marquee direction="left">
                <p class="p-subheader">Copyright all rights reserved 2023 by Aryajaya Alamsyah, S.Kom</p>
            </marquee>
		</div>
        <!-- ./footer -->
